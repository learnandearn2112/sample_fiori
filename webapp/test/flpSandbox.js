		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flight Detail",
									"targetURL": "#comdemozflight-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemozflight-display": {
								"semanticObject": "comdemozflight",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.zflight",
									"url": sap.ui.require.toUrl("com/demo/zflight")
								}
							}
						}
					}
